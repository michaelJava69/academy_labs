...
module "stage-compute"  {
   ...
   source = "github.com/michaelJava69/academy_labs//mod_demo_lab/modules/compute?ref=v1.0"
...
module "stage-network" {
   ...
   source = "github.com/michaelJava69/academy_labs//mod_demo_lab/modules/network?ref=v1.0"
...
module "stage-lb" {
   ...
   # source = "../../../modules/lb"
   source = "github.com/michaelJava69/academy_labs//mod_demo_lab/modules/lb?ref=v1.0"
