...
echo "<BR><BR>Terraform autoscaled app multi-cloud lab  Michael Changed<BR><BR>" >> /var/www/html/index.html
EOF
}
...
## map
variable "ohio_azs"  {
    default =  {az1="us-east-2%s",az2="us-east-2%s",az3="us-east-2%s"} 
}
